...
export default function LoginScreen() {
  ...
  return (
    <div className="min-h-screen bg-bg flex items-center justify-center p-6 font-sans">
      <div className="w-full max-w-sm card-premium-mono p-8 text-center space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-text mb-2">Utopia</h1>
          <p className="text-sub text-sm">Sign in to access your notes and notebooks.</p>
        </div>

        <button
          onClick={handleLogin}
          disabled={isSigningIn}
          className="w-full btn-premium-mono py-2.5 px-4 flex items-center justify-center gap-3 rounded cursor-pointer"
        >
          {isSigningIn ? (
