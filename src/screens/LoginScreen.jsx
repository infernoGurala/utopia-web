          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <div className="w-full space-y-4">
              ...
              <button 
                ...
                disabled={isSigningIn}
                className="w-full py-4 px-6 border border-primary/30 hover:border-primary bg-primary/5 hover:bg-primary/10 text-primary font-semibold text-lg rounded-2xl transition-all duration-300 active:scale-[0.98]"
              >
                Continue on Web
              </button>
            </div>
